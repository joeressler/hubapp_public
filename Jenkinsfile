        ...
        stage('Deploy to EC2') {
            ...
            steps {
                script {
                    ...
                    bat "ssh -i ${EC2_KEY_PATH} -vvv -o StrictHostKeyChecking=no ec2-user@ec2-3-88-156-217.compute-1.amazonaws.com 'COMPOSE_HTTP_TIMEOUT=300 docker-compose up -d --force-recreate'"
                }
            }
        }
